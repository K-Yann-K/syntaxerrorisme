...
export default function Header() {
    ...
    <header className="bg-swiss-coffee-300 shadow-sm w-full">
        ...
        {/* --- TOP BAR --- */}
        <article className="flex items-center justify-between pt-3.5 pb-3.5 px-2.5 sm:px-5 md:px-5 md:gap-5">
            
            <header className="relative group">
                <Link href={"/"}>
                    <h1 className="text-strikemaster-990  text-shadow-2xs glitch font-black text-lg flex items-center gap-2">
                ...
                <p className="w-full text-center italic absolute hidden md:block top-[70%] left-[58%] transform -translate-x-1/2 opacity-0 group-hover:opacity-100 group-hover:translate-y-2 text-strikemaster-600 text-xs sm:text-xs font-medium transition-all duration-300">
            ...
            {/* --- DESKTOP NAV --- */}
            <nav className="hidden md:flex text-gray-800 items-center text-lg md:gap-5 lg:gap-12">
                ...
                <Link href={"/histoire"} className="font-medium glitch flex items-center gap-2 transition-all duration-200 hover:[text-shadow:_0_0_0.8px_currentColor]">
